...
if(isset($_POST['btn_submit']))
{
	...
	$ins="insert into tbl_user(user_name,user_email,user_contact,user_address,user_image,place_id,user_password,user_proof)
	values('".$name."','".$email."','".$contact."','".$address."','".$image."','".$place."','".$password."','".$proof."')";
	echo $ins;
