	...
	if(isset($_POST["btn_update"]))
{
	...
	if($db_password==$current_password)
	{
		...
		{
		  $upQry = "update tbl_user set user_password='$new_password' where user_id='".$_SESSION["userid"]."'";
...
<table width="400" border="1">
  ...
  <tr>
    <td width="100">Current password</td>
    <label for="current_password"></label>
    <td width="100"><input type="password" name="current_password"></td>
  </tr>
  <tr>
    <td>New Password</td>
