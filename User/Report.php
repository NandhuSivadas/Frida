...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th style="text-align:center">Sl.No</td>
                    <th style="text-align:center">Date</td>
                    <th style="text-align:center">Fat</td>
                    <th style="text-align:center">Reading</td>
                    <th style="text-align:center">litre</td>
                    <th style="text-align:center">Total Amt</td>
        ...
        $s=0;
        session_start();
       $selQry="select * from tbl_milkcollection r inner join tbl_user u on r.user_id=u.user_id where r.user_id='".$_SESSION["userid"]."'";
