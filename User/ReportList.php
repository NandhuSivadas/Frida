        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Litre</th>
			...
			<?php
				...
				$i=0;
			 $selQry = "select * from tbl_user u inner join tbl_milkcollection m on u.user_id=m.user_id where u.user_id='".$_SESSION["userid"]."' ";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["collection_date"]; ?></td>
                 <td align="center"><?php echo $data["user_name"]; ?></td>
                 <td align="center"><?php echo $data["collection_litre"]; ?></td>
                 <td align="center"><?php echo $data["collection_reading"]; ?></td>
                 <td align="center"><?php echo $data["collection_totalamt"]; ?></td>
              </tr>
               <?php
				}
			?>
