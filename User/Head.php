...
<body>
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5" style="border-bottom: 1px solid black;">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Milk</a>
                    <div class="dropdown-menu bg-light m-0">
                       
                        <a href="MilkcollectionReport.php" class="dropdown-item">Milk collection Record</a>
                        <a href="NotificationDisplay.php" class="dropdown-item">Notification</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="UserComplaintSolvedList.php" class="dropdown-item">complaint View</a>
