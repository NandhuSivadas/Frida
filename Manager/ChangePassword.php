	...
	if(isset($_POST["btn_update"]))
{
	...
	$db_password=$row["manager_password"];
	...
	if($db_password==$current_password)
	{
		...
		{
		  $upQry = "update tbl_manager set manager_password='$new_password' where manager_id='".$_SESSION["managerid"]."'";
...
<title>Style::ManagerChangePassword</title>
</head>
