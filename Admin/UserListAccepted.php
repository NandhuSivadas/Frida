...
include("../Assets/connection/connection.php");
   ...
   if($_GET["reject"])
   {
	   ...
	   mysql_query($delQry);
	   header("location:UserListAccepted.php");
   }
...
<title>UserListAccepted</title>
</head>

<body>
<!-- <a href="HomePage.php">Home</a> -->
<h2>User List Accepted</h2><br>
<table width="200" border="1" align="center">
  ...
  $selQry= "select * from tbl_user u inner join tbl_place p on u.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where u.user_status='1'";
	...
	while($row=mysql_fetch_array($data))
     ...
     <td><a href="UserListAccepted.php?reject=<?php echo $row["user_id"]?>">Reject</a></td>
