                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
												$i = 0;
                                                $selQry = "select * from tbl_complaint c inner join tbl_user u on c.user_id=u.user_id where compliant_status='0'";
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
												$i = 0;
                                                $selQry = "select * from tbl_complaint c inner join tbl_user u on c.user_id = u.user_id where compliant_status='1'";
