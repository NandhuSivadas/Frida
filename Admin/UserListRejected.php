...
if($_GET["accept"])
      ...
      if($_GET["delete"])
   {
	   ...
	   echo $delQry;
	   mysql_query($delQry);
	 // header("location:UserListRejected.php");
   }
...
<title>UserListRejected</title>
</head>

<body>
<!-- <a href="HomePage.php">Home</a> -->
<h2>User List Rejected</h2><br>
<table width="200" border="1" align="center">
  ...
  $selQry= "select * from tbl_user u inner join tbl_place p on u.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where u.user_status='2'";
	...
	while($row=mysql_fetch_array($data))
     ...
     <td><a href="UserListRejected.php?accept=<?php echo $row["user_id"]?>">Accept</a></td>
     <td><a href="UserListRejected.php?delete=<?php echo $row["user_id"]?>">delete</a></td>
